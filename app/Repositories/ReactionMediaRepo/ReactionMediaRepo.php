...
/**
 * Class ReactionMediaRepo.
 */
class ReactionMediaRepo extends BaseRepository implements ReactionMediaRepoInterface
{
    /**
     * UserRepository constructor.
     */
    public function __construct(ReactionMedia $model)
    {
